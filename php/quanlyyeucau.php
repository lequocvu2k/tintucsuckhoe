...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['approve_request'])) {
    ...
    $_SESSION['msg'] = "✅ Yêu cầu đã được duyệt!";
                    ...
                    <tr>
                        ...
                        <td>
                            <div class="avatar-container">
                                ...
                                $stmt = $pdo->prepare("SELECT avatar_url, avatar_frame FROM khachhang WHERE id_kh = ?");
                                $stmt->execute([$id_kh]);
                                $user = $stmt->fetch(PDO::FETCH_ASSOC);
                        ...
                        <td><span
                                class="<?= strtolower(str_replace(' ', '-', $request['trang_thai'])) ?>"><?= htmlspecialchars($request['trang_thai']) ?></span>
                        </td>
                        <td>
